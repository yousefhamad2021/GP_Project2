...
import com.graduate.project.adapter.CartAdapter
import com.graduate.project.database.AsyncTaskCompleteListener
import com.graduate.project.database.ClearCartAsyncTask
import com.graduate.project.database.RetrieveCartAsyncTask
...
class CartActivity : AppCompatActivity() {
    ...
    private fun networkRequest() {
        ...
        NetworkTask(networkTaskListener).makeNetworkRequest(
            this@CartActivity, Request.Method.POST, "", jsonParams
        )
    }
    ...
    private fun navigateToDashboard() {
        val intent = Intent(this@CartActivity, com.graduate.project.activity.DashboardActivity::class.java)
